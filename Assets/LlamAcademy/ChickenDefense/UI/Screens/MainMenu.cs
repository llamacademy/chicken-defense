...
namespace LlamAcademy.ChickenDefense.UI.Screens
{
    public class MainMenu : VisualElement
    {
        ...
        private GameObject[] ObjectsToDeactivateOnPlay;
        ...
        private void HandlePlayClick(ClickEvent _)
        {
            ...
            VisualElement runtimeUI = panel.visualTree.Q("runtime-ui");
            runtimeUI.RemoveFromClassList("disabled");
            MenuRoot.AddToClassList("disabled");
            OnClose?.Invoke();
        }
